...
% Copyright (c) 2005, 2009, 2010, 2011, 2016, 2020
...
classdef (InferiorClasses = {?sym}) quaternion % Note 1.
    ...
    methods
        function q = quaternion(a0, a1, a2, a3)
            % QUATERNION   Construct quaternions from components. Accepts the
            % following possible arguments, which may be scalars, vectors or
            % matrices; numeric, logical or symbolic. In addition character
            % arrays may be passed to create symbolic components with the given
            % names (these must not already exist, otherwise they should be
            % passed by name).
            %
            % No argument     - returns an empty quaternion scalar, vector or
            %                   matrix.
            % One argument    - A quaternion argument returns the argument
            %                   unmodified. A non-quaternion argument returns
            %                   the argument in the scalar part and supplies a
            %                   zero vector part with elements of the same type
            %                   as the scalar part.
            ...
            switch nargin
                ...
                case 1
                    ...
                    if isa(a0, 'quaternion')
                        ...
                        if isnumeric(a0)
                            ...
                            % of the quaternion, and they must have the
                            % same type as a0 (e.g. double, int8), for
                            % which we use the class option to the zeros
                            % function.
                ...
                case 2
                    ...
                    % quaternion (with components of the same class as the
                    % first argument).
...
% $Id: quaternion.m 1103 2020-07-20 18:44:32Z sangwine $
